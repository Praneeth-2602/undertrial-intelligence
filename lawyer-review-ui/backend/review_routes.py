...
HOW TO PLUG IN:
  In your existing main.py, add these two lines after the other imports:

      from review_routes import router as review_router
      app.include_router(review_router)

That's it. Three new endpoints appear:
  POST /review              — submit or update a lawyer verdict
  GET  /review/{case_id}   — fetch review for one case
  GET  /reviews            — list all reviews (for the dashboard)
"""
